/**
 * [not is usage, but just keep this in lib]
 *
 * Tell whether the rect is visible, given with an offset
 *
 * @param {Object} offset
 * @param {String} [offset.direction]
 ...
 * @param {Object} containmentRect
 * @param {Number} [containmentRect.top]
 * @param {Number} [containmentRect.left]
 * @param {Number} [containmentRect.bottom]
 * @param {Number} [containmentRect.right]
 *
 * @returns {Boolean}
 * */
...
module.exports = isVisibleWithOffset;
